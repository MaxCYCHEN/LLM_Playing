...
class QA_LangChain():
    def __init__(self):
        ...
        self.system_template = """You are a C firmware engineer, and good at produce a C code basing on anyone's question.
Use the following pieces of context and chat history to answer the question at the end. 
The context is standard driver C header files of M460 MCU.
Answer the question with ONLY one C function as complete as possible. Don't add any extra explanation.
...
#{chat_history}"""
    ...
    def QA_LangChain_RQA_chain(self, input_doc_pth, qa_prompt):
        ...
        # LanceDB
        #p = Path(input_doc_pth)
        #print(p.parent, p.stem)
        #db = lancedb.connect(r'D:\nu_QA_data\lanceDB')
        #table = db.open_table('TRM_m460')
    ...
    # Adding LangSmith
    def langsmith_create(self, doc_name):
        os.environ["LANGCHAIN_TRACING_V2"] = "true"
        os.environ["LANGCHAIN_PROJECT"] = "RAGchain_Terry_{}".format(doc_name)
        os.environ["LANGCHAIN_ENDPOINT"] = "https://api.smith.langchain.com"
        os.environ["LANGCHAIN_API_KEY"] = "ls__c2b7c411d3754887a3b9fb04efb976bd"  # Update to your API key
...
class QA_UI():
    def __init__(self):
        ...
        #self.doc_path = os.path.join(self.qa_doc_dir, r'TRM_M463_M467_pypdf')
